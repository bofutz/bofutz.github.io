    ...
    <div>
      ...
      <aside class="fixed inset-y-0 left-0 w-64 bg-white z-50 transform transition-transform duration-300 flex flex-col shadow-2xl select-none"
        ...
        <div class="h-14 sm:h-16 theme-bg text-white flex items-center justify-between px-5 text-lg tracking-wider">
          ...
          <button @click="closeSidebar" class="text-white/70 hover:text-white"><i class="fa-solid fa-xmark text-xl"></i></button>
        </div>
        ...
        <div class="flex-1 overflow-y-auto py-2 custom-scrollbar">
          ...
          <div @click="navigate('#/profile', true)" class="nav-item block px-6 py-3.5 border-b border-slate-50" :class="{active: currentRoute === '#/profile'}">
          ...
          <div @click="navigate('#/tickets', true)" class="nav-item block px-6 py-3.5 border-b border-slate-50" :class="{active: currentRoute === '#/tickets'}">
