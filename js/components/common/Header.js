/* ========================= FILE: .\js\components\common\Header.js ========================= */
        ...
        <div class="flex items-center gap-2">
          ...
          <template v-else>
            ...
            <button type="button" @click="openAuth"
                    class="text-xs sm:text-sm px-3.5 py-1.5 rounded-lg bg-emerald-500 hover:bg-emerald-600 text-white font-bold flex items-center gap-1.5 shadow-sm transition-colors">
              <i class="fa-brands fa-weixin text-base"></i> 微信快捷登录
            </button>
          </template>
